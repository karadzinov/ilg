...
<div class="page-body">
    <div class="row">
        <div class="col-lg-offset-1 col-sm-offset-1 col-lg-10 col-sm-10 col-xs-12">
            ...
            <div class="widget">
                ...
                <div class="widget-body">
                   @if(!!$user->image) 
                   <img src="/assets/img/avatars/thumbnails/{{ $user->image }}" alt="{{ $user->name }}" class="img-responsive" />
                   @endif
                   <div class="col-md-12 pull-right profile-header row">
                   </div>

                   <div id="horizontal-form">
                    <form role="form" method="POST" action="{{ url('/admin/users/updateuser') }}" enctype="multipart/form-data">
                     {!! csrf_field() !!}
        ...
        <a href="/admin/users" class="btn btn-labeled shiny btn-default btn-large"><i class="btn-label fa fa-arrow-circle-left"></i> Cancel</a>
    </form>
