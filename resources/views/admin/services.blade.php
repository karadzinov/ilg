            ...
            <div class="col-lg-12">
                <div class="widget">
                    <div class="widget-header bordered-bottom bordered-themesecondary">
                        ...
                        <span class="widget-caption themesecondary">Услуга</span>
                    </div><!--Widget Header-->
                            ...
                            <ul class="tickets-list">
                                @foreach($services as $service)
                                    <li class="ticket-item">
                                        <div class="row">
                                            <a href="/admin/services/{{ $service->id }}/edit" class="info">
                                                <div class="ticket-user col-lg-3 col-sm-12">
                                                    @if($service->image)
                                                        <img src="/assets/img/services/thumbnails/{{ $service->image }}" class="user-avatar">
                                                    @endif
                                                    <span class="user-name">{{ $service->title }}</span>
                                                </div>
                                                <div class="ticket-time col-lg-3 col-sm-6 col-xs-12">
                                                    <div class="divider hidden-md hidden-sm hidden-xs"></div>
                                                    <span class="time">Original creator: {{ $service->createdby->name }}</span>
                                                </div>
