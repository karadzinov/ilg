            ...
            <div class="widget">
                ...
                <div class="widget-body">
                    <div id="horizontal-form">
                     <form role="form" method="POST" action="{{ url('/admin/users/register') }}">
                         {!! csrf_field() !!}
                        ...
                        <div class="form-group{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
                            <span class="input-icon icon-right">
                                <input type="password" class="form-control" id="confirmPasswordInput" name="password_confirmation" placeholder="Confirm Password">
                                <i class="fa fa-lock circular"></i>
                            </span>
                        ...
                        <button type="submit" class="btn btn-labeled shiny btn-warning btn-large"><i class="btn-label fa fa-plus"></i> Register</button>
                    </form>
