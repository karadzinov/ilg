        ...
        <div class="col-lg-offset-1 col-sm-offset-1 col-lg-10 col-sm-12 col-xs-12">
            ...
            <div class="widget">
                ...
                <div class="widget-body">
                    ...
                    <div class="img-blog">
                        @if(!!$blog->image) 
                        <img class="img-responsive" src="/assets/img/blog/medium/{{ $blog->imagemedium }}" alt="{{ $blog->title }}"/>
                        @endif
                    </div>
                    <br />
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="ckeditor" id="subtitle" name="subtitle">{{ $blog->subtitle }}</textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="region_id[]" id="region" class="form-control" multiple="">
                            ...
                            <option value="{{ $region->id }}" 
                                @if(is_array(explode(",",$blog->region_id)))

                                @if(in_array($region->id, explode(",",$blog->region_id)))
                        ...
                        <div class="form-group">
                            ...
                            <select name="country_id" id="country" class="form-control">
                                ...
                                <option value="{{ $country->id }}" @if($country->id == $blog->country_id) selected @endif>{{ $country->name }}</option>
                                @endforeach
                        ...
                        <div class="form-group">
                            ...
                            <label>
                                <input name="workflow_id" type="radio" class="form-control {{ $workflow->color }}" value="{{ $workflow->id }}" @if($workflow->id  == $blog->workflow_id) checked @endif>
